...
### Senior Full-Stack Developer &nbsp;·&nbsp; Laravel & FilamentPHP Specialist

**9+ years** building production backend systems, APIs, and admin platforms for businesses across e-commerce, HR, logistics, telehealth, and media.

[![Download CV][resume-icon]][resume-url]
[![Email][email-icon]][gmail-url]
...
I'm a full-stack developer specializing in **Laravel** and **FilamentPHP**, with a track record of shipping scalable backend systems, REST APIs, and admin dashboards for real clients — not just side projects. I've held **Senior Software Engineer** roles across multiple full-stack engagements, and I publish reusable open-source packages that other developers rely on in production.

I'm comfortable owning a feature end-to-end: architecture, database design, API integration, deployment, and maintenance. I also have working experience with **Yii2, CodeIgniter, Zend, Angular, Ionic,** and **Webflow**, so I can slot into legacy codebases as easily as greenfield builds.
...
| Area | Skills |
|---|---|
| **Backend** | Laravel, FilamentPHP, Yii2, CodeIgniter, Zend, PHP |
| **Frontend** | Angular, Ionic, Webflow, Redux |
| **Cloud & Infra** | AWS, Google Cloud Platform, Docker, Heroku |
| **Data & Realtime** | MySQL, PostgreSQL, Socket.IO |
| **AI-Assisted Development** | Claude, Cursor |
| **Workflow & PM** | Git, NPM, Node.js, Jira |
...
[![Yii2][yii2-icon]][yii2-url]
[![CodeIgniter][codeigniter-icon]][codeigniter-url]
[![Zend][zend-icon]][zend-url]
...
[![Claude][claude-icon]][claude-url]
[![Cursor][cursor-icon]][cursor-url]
...
| [CLN Intranet][cln-url] | Senior Software Engineer | Full Stack |
| [Gapan Fresh Eggs][gapan-url] | Senior Software Engineer | Full Stack |
| [Mr. Pickup PH][pickup-url] | Senior Software Engineer | Full Stack |
| [BlueHour Visuals][bluehour-url] ↗ | Developer | Webflow |
| [Carrux][carrux-url] | Junior Programmer | Ionic |

<sub>↗ live site &nbsp;·&nbsp; unmarked = private/portfolio repository</sub>

<br/>

## Open-Source Contributions

Publishing maintained, documented packages signals code I'm comfortable putting my name on outside of client NDAs:

| Package | Type | Status |
|---|---|---|
| [Filament One][filament-one-url] | Filament v3 starter kit | 🆕 Active |
| [ApcoPay][apcopay-url] | Laravel payment gateway integration | 🆕 Active |
| [Azure Blob SAS URL Generator][azure-url] | Laravel + Spatie Media Library | 🆕 Active |
| [Filament Messages][messages-url] | Filament v3 real-time messaging plugin | Active |
| [Chargify (Maxio)][chargify-url] | Laravel billing integration | Active |
| [Image Resize][imageresize-url] | Laravel image processing | Active |
...
<div align="center">
  <img src="https://github-stats-extended.vercel.app/api?username=jeddsaliba&show_icons=true" alt="Jedd Saliba's GitHub Stats" width="53%" />
  <img src="https://github-stats-extended.vercel.app/api/top-langs?username=jeddsaliba&langs_count=10&show_icons=true&locale=en&layout=compact&theme=light" alt="Jedd Saliba's Top Languages" width="44.74%" />
</div>
...
I'm open to discussing full-time, contract, or project-based roles. If you're hiring for a Laravel/Filament role or need a full-stack engineer who can own delivery, reach out directly.

<div align="center">

[![Gmail][email-badge]][gmail-url]
...
[cln-url]: https://github.com/jeddsaliba/cln-intranet
[gapan-url]: https://github.com/jeddsaliba/gapan-fresh-eggs
[pickup-url]: https://github.com/jeddsaliba/mr-pickup-ph
[bluehour-url]: https://bluehourvisuals.webflow.io
[carrux-url]: https://github.com/jeddsaliba/carrux

<!-- Package links -->
[filament-one-url]: https://packagist.org/packages/jeddsaliba/filament-one
[apcopay-url]: https://packagist.org/packages/jeddsaliba/laravel-apcopay
[azure-url]: https://packagist.org/packages/jeddsaliba/azure-blob-url-generator
[messages-url]: https://packagist.org/packages/jeddsaliba/filament-messages
[chargify-url]: https://packagist.org/packages/jscustom/laravel-chargify
[imageresize-url]: https://packagist.org/packages/jscustom/laravel-image-resize
...
[yii2-icon]: https://img.shields.io/badge/Yii2-0073BB?style=for-the-badge
...
[zend-icon]: https://img.shields.io/badge/Zend-0679C1?style=for-the-badge
[zend-url]: https://framework.zend.com
...
[claude-icon]: https://img.shields.io/badge/Claude-D97757?style=for-the-badge&logo=anthropic&logoColor=white
[claude-url]: https://claude.ai
[cursor-icon]: https://img.shields.io/badge/Cursor-000000?style=for-the-badge
[cursor-url]: https://cursor.sh
